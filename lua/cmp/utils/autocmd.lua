...
---@param callback fun(state:vim.api.keyset.create_autocmd.callback_args)
---@return function
...
---Emit autocmd
---@param event string
---@param state vim.api.keyset.create_autocmd.callback_args
autocmd.emit = function(event, state)
  debug.log(' ')
